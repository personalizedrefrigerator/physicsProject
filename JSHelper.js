var JSHelper =
{
    ...
    "colorData": { "green": [0.0, 1.0, 0.0, 1.0], "red": [1.0, 0.0, 0.0, 1.0], "blue": [0.0, 1.0, 0.0, 1.0], "purple": [1.0, 0.0, 1.0, 1.0], "yellow": [1.0, 1.0, 0.0, 1.0] },
    "colorStringToArray": function(colorData)
    {
        var color = [0, 0, 0, 0.0];
        
        if (!(colorData in JSHelper.colorData))
        {
        ...
        {
            for(var i in JSHelper.colorData[colorData])
            {
                color[i] = JSHelper.colorData[colorData][i];
            }
        }
